...
const trelloWrapper = {
  ...
  getBoardMemberships: function (token, callback) {
    return this.get(`/1/boards/${boardID}/memberships/?member=true&member_fields=fullName,avatarUrl,avatarHash,initials,username`, {
      qs: {
        token,
        member: true
      }
